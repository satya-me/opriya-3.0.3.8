<?php
class ControllerWebExtensionAccountPurpletreeMultivendorQuickOrder extends Controller{
	private $error = array();	
	public function index(){
		if (!$this->customer->isLogged()) {
			$this->session->data['quick_redirect'] = $this->url->link('web/extension/account/purpletree_multivendor/quick_order', '&product_id='.$this->request->get['product_id'].$url, true);
