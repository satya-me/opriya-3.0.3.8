<?php
class ControllerWebExtensionAccountPurpletreeMultivendorSellerblogpost extends Controller {
		private $error = array();
		
		public function index() {
			
			if (!$this->customer->isLogged()) {
				$this->session->data['redirect'] = $this->url->link('web/extension/account/purpletree_multivendor/sellerblogpost', '', true);
		...
		public function add(){
			...
			if(!$this->customer->validateSeller()) {
				...
				$this->response->redirect($this->url->link('web/extension/account/purpletree_multivendor/sellerblogpost', '', true));
			}
			$this->load->language('purpletree_multivendor/sellerblogpost');
		...
		protected function getList() {
			...
			'href' => $this->url->link('web/extension/account/purpletree_multivendor/sellerblogpost', $url, true)
			);		
			$this->load->model('extension/purpletree_multivendor/dashboard');
			
			$this->model_extension_purpletree_multivendor_dashboard->checkSellerApproval();
			
			$data['add'] = $this->url->link('web/extension/account/purpletree_multivendor/sellerblogpost/add', $url, true);
			$data['copy'] = $this->url->link('web/extension/account/purpletree_multivendor/sellerblogpost/copy', $url, true);
			$data['delete'] = $this->url->link('web/extension/account/purpletree_multivendor/sellerblogpost/delete', $url, true);
			...
			foreach ($results as $result) {
				...
				'edit'       => $this->url->link('web/extension/account/purpletree_multivendor/sellerblogpost/edit',  '&blog_post_id=' . $result['blog_post_id'] . $url, true)
				);
			}
			...
			$data['sort_title'] = $this->url->link('web/extension/account/purpletree_multivendor/sellerblogpost', '&sort=bp.title' . $url, true);
			$data['sort_status'] = $this->url->link('web/extension/account/purpletree_multivendor/sellerblogpost', '&sort=p.status' . $url, true);
			$data['sort_order'] = $this->url->link('web/extension/account/purpletree_multivendor/sellerblogpost', '&sort=p.sort_order' . $url, true);
			...
			$pagination->url = $this->url->link('web/extension/account/purpletree_multivendor/sellerblogpost', $url . '&page={page}', true);
			...
			$this->response->setOutput($this->load->view('web/account/purpletree_multivendor/sellerblogpost_list', $data));
		}
		...
		protected function getForm() {
			...
			if (!isset($this->request->get['blog_post_id'])) {
				$data['action'] = $this->url->link('web/extension/account/purpletree_multivendor/sellerblogpost/add', $url, true);
				} else {
				$data['action'] = $this->url->link('web/extension/account/purpletree_multivendor/sellerblogpost/edit', '&blog_post_id=' . $this->request->get['blog_post_id'] . $url, true);
			}
			
			$data['cancel'] = $this->url->link('web/extension/account/purpletree_multivendor/sellerblogpost' . $url, true);
			...
			$data['footer'] = $this->load->controller('web/common/footer');
			$data['header'] = $this->load->controller('web/common/header');
			$this->response->setOutput($this->load->view('web/account/purpletree_multivendor/sellerblogpost_form', $data));
		}
