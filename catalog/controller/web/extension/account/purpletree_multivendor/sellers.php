<?php
class ControllerWebExtensionAccountPurpletreeMultivendorSellers extends Controller
{
    public function index()
    {
        ...
        $data['breadcrumbs'][] = array(
            ...
            'href' => $this->url->link('web/extension/account/purpletree_multivendor/sellers', $url, true),
        );
        ...
        foreach ($seller_lists as $seller_list) {
            ...
            foreach ($results as $result) {
                ...
                $data['products'][] = array(
                    'thumb' => $image,
                    'href' => $this->url->link('web/product/product', 'product_id=' . $result['product_id'], true),
                );
            }
            ...
            $data['sellers'][] = array(
                ...
                'href' => $this->url->link('web/extension/account/purpletree_multivendor/sellerstore/storeview', 'seller_store_id=' . $seller_list['id'], true),
                'seller_contact' => $this->url->link('web/extension/account/purpletree_multivendor/sellercontact/customerreply', 'seller_id=' . $seller_list['seller_id'], true),
        ...
        $data['sorts'][] = array(
            ...
            'value' => 'seller-ASC',
            'href' => $this->url->link('web/extension/account/purpletree_multivendor/sellers', 'sort=seller&order=ASC' . $url, true),
        );

        $data['sorts'][] = array(
            'text' => $this->language->get('text_name_desc'),
            'value' => 'seller-DESC',
            'href' => $this->url->link('web/extension/account/purpletree_multivendor/sellers', 'sort=seller&order=DESC' . $url, true),
        );
        ...
        foreach ($limits as $value) {
            $data['limits'][] = array(
                'text' => $value,
                'value' => $value,
                'href' => $this->url->link('web/extension/account/purpletree_multivendor/sellers', $url . '&limit=' . $value, true),
            );
        }
        ...
        $pagination->url = $this->url->link('web/extension/account/purpletree_multivendor/sellers', $url . '&page={page}', true);
        ...
        $this->response->setOutput($this->load->view('web/account/purpletree_multivendor/sellers', $data));
    }
}
