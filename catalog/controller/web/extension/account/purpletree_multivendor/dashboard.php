<?php
class ControllerWebExtensionAccountPurpletreeMultivendorDashboard extends Controller {
		private $error = array();
		...
		public function index(){
			...
			'href' => $this->url->link('web/extension/account/purpletree_multivendor/dashboard', $url, true)
			);
			$data['my_orders']=$this->url->link('web/extension/account/purpletree_multivendor/sellerorder', $url, true);
			
			$data['my_commission']=$this->url->link('web/extension/account/purpletree_multivendor/sellercommission', $url, true);
			
			$data['my_payments']=$this->url->link('web/extension/account/purpletree_multivendor/sellerpayment', $url, true);
			$data['my_sales']=$this->url->link('web/extension/account/purpletree_multivendor/sellerorder', $url, true);
			...
			$this->response->setOutput($this->load->view('web/account/purpletree_multivendor/dashboard', $data));
		}
}