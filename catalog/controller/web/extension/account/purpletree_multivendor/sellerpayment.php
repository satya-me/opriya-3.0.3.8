<?php
class ControllerWebExtensionAccountPurpletreeMultivendorSellerpayment extends Controller{
		public function index(){
			...
			if (!$this->customer->isLogged()) {
				$this->session->data['redirect'] = $this->url->link('web/extension/account/purpletree_multivendor/sellerpayment', '', true);
			...
			'href' => $this->url->link('web/extension/account/purpletree_multivendor/sellerpayment', '', true)
			);
			...
			$pagination->url = $this->url->link('web/extension/account/purpletree_multivendor/sellerpayment', 'page={page}', true);
			...
			$this->response->setOutput($this->load->view('web/account/purpletree_multivendor/payment_list', $data));
		}
	}
?>