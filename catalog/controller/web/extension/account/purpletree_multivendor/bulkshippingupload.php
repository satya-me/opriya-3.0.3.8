<?php
class ControllerWebExtensionAccountPurpletreeMultivendorBulkshippingupload extends Controller{
		private $error = array();
		public function index(){
			...
			if (!$this->customer->isLogged()) {
				$this->session->data['redirect'] = $this->url->link('web/extension/account/purpletree_multivendor/bulkshippingupload', '', true);
		...
		public function upload(){
			...
			if(!$this->customer->validateSeller()) {
				...
				$this->response->redirect($this->url->link('web/extension/account/purpletree_multivendor/bulkshippingupload', '', true));
			}
			$cwd = getcwd();
			...
			if (($this->request->server['REQUEST_METHOD'] == 'POST')) {
				...
				if($_FILES["import"]['tmp_name'] != '') {	
					...
					if(in_array($_FILES["import"]["type"],$mimes)){
						...
						$url='';
						$this->response->redirect($this->url->link('web/extension/account/purpletree_multivendor/bulkshippingupload', '' . $url, true));
						} else {
		...
		public function getData(){	
			...
			'href' => $this->url->link('web/extension/account/purpletree_multivendor/bulkshippingupload', '' . $url, true)
			);
			...
			$data['export'] = $this->url->link('web/extension/account/purpletree_multivendor/bulkshippingupload/export', '', true);	
			$data['upload'] = $this->url->link('web/extension/account/purpletree_multivendor/bulkshippingupload/upload', '', true);	
			...
			$this->response->setOutput($this->load->view('web/account/purpletree_multivendor/bulkshipping_upload', $data));
		}
	}
