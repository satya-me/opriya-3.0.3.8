<?php
class ControllerWebExtensionAccountPurpletreeMultivendorSubscriptionplan extends Controller {
		
		private $error = array();
		
		public function index() {
			if (!$this->customer->isLogged()) {
				$this->session->data['redirect'] = $this->url->link('web/extension/account/purpletree_multivendor/dashboard', '', true);
		...
		public function addSellerPaymentComment() {
			...
			if (($this->request->server['REQUEST_METHOD'] == 'POST')  && $this->validateForm() ) {
				...
				$url ='';
				$this->response->redirect($this->url->link('web/extension/account/purpletree_multivendor/subscriptionplan/invoice', '' . 'invoice_id=' . $this->request->post['invoice_id'] .'&old_invoice_id='.$this->request->get['invoice_id']. $url, true));
			}
			$this->getplan();
		}
		public function paymentOffline(){ 
			...
			'href' => $this->url->link('web/extension/account/purpletree_multivendor/subscriptionplan', $url, true)
			);
			...
			$data['action']=$this->url->link('web/extension/account/purpletree_multivendor/subscriptionplan/addSellerPaymentComment', '' . 'invoice_id=' . $invoice_id .'&old_invoice_id='.$old_invoice_id. $url, true);
			...
			$this->response->setOutput($this->load->view('web/account/purpletree_multivendor/offline_payment_form', $data));
		...
		public function invoice(){ 
			...
			$data=array();
			//paypal data
			$data['return_url'] = $this->url->link('web/extension/account/purpletree_multivendor/subscriptionplan/invoice/', '&invoice_id='.$invoice_id.'&paymentfrom=paypal', true);
			$data['notify_url'] = $this->url->link('web/extension/account/purpletree_multivendor/subscriptionplan/notify', '', true);
			...
			if(!empty($result)){
				...
				'subscribe'        =>$this->url->link('web/extension/account/purpletree_multivendor/dashboard', '' . 'plan_id=' . $result['plan_id'] . $url, true)
			...
			$data['payment_offline']=$this->url->link('web/extension/account/purpletree_multivendor/subscriptionplan/paymentOffline', '' . 'invoice_id=' . $invoice_id .'&old_invoice_id='.$old_invoice_id. $url, true);
			
			$data['payment_online']=$this->url->link('web/extension/account/purpletree_multivendor/subscriptionplan/paymentOffline', '' . 'invoice_id=' . $invoice_id . $url, true);
			
			$data['print_invoice']=$this->url->link('web/extension/account/purpletree_multivendor/subscriptionplan/print_invoice', '' . 'invoice_id=' . $invoice_id . $url, true);
			...
			$this->response->setOutput($this->load->view('web/account/purpletree_multivendor/seller_subscription_plan_invoice', $data));
		}	
		...
		public function print_invoice(){ 
			...
			$this->response->setOutput($this->load->view('web/account/purpletree_multivendor/print_subscription_plan_invoice', $data));
		}
		...
		public function subscribe(){ 
			...
			if(!isset($this->request->get['plan_id'])){
				$this->response->redirect($this->url->link('web/extension/account/purpletree_multivendor/subscriptionplan', '', true));	
			}
			...
			$data['action'] = $this->url->link('web/extension/account/purpletree_multivendor/subscriptionplan/add', '', true);
			$data['seller_id']=$seller_id;
			$data['plan_id']=$plan_id;
			$data['column_left'] = $this->load->controller('web/common/column_left');
			$data['column_right'] = $this->load->controller('web/common/column_right');
			...
			$this->response->setOutput($this->load->view('web/account/purpletree_multivendor/plan_confirmation', $data));
		}	
		...
		public function getPlan(){ 
			...
			if(isset($results)){
				foreach ($results as $result) {
					...
					if($invoice_status ==2 or $invoice_status ==NULL){
						...
						$link=$this->url->link('web/extension/account/purpletree_multivendor/subscriptionplan/subscribe', 'plan_id='.$result['plan_id'].'&status='.$pts_sts, true);
						
						} else {
						$this->session->data['error_warning'] =$this->language->get('error_subscription_plan_pending');
						//unset($this->session->data['error_warning']);
						$link=$this->url->link('web/extension/account/purpletree_multivendor/subscriptionplan','', true);	
					}
					...
					'invoice'=>$this->url->link('web/extension/account/purpletree_multivendor/subscriptions&filter_plan_id='.$result['plan_id'], '', true)
			...
			$this->response->setOutput($this->load->view('web/account/purpletree_multivendor/subscription_plan', $data));
