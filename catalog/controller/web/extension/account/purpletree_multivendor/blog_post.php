<?php
class ControllerWebExtensionAccountPurpletreeMultivendorBlogPost extends Controller{
		private $error = array();
		...
		public function index(){ 
			...
			if ($post_info) {
				...
				'href' => $this->url->link('web/extension/account/purpletree_multivendor/blog_post', 'blog_post_id=' .  $blog_post_id,true)
				);
				...
				$data['action'] = $this->url->link('web/extension/account/purpletree_multivendor/blog_post/addcomment', 'blog_post_id=' . $blog_post_id,true);
				...
				if ($results) {
					foreach ($results as $result) {
						...
						'title'         => $result['title'],
						'date'          => date('d M'),
						'href'          => $this->url->link('web/extension/account/purpletree_multivendor/blog_post', 'blog_post_id=' . $result['blog_post_id'],true)
						);
					}
				}
				...
				$this->response->setOutput($this->load->view('web/account/purpletree_multivendor/blog_post_detail', $data));
				} else {
				$data['breadcrumbs'][] = array(
		...
		public function addcomment(){
			...
			if (($this->request->server['REQUEST_METHOD'] == 'POST') && $this->validateForm()) { 
				...
				$this->response->redirect($this->url->link('web/extension/account/purpletree_multivendor/blog_post', 'blog_post_id='.$this->request->get['blog_post_id'], true));
			}
		...
		public function all_blog(){    
			...
			'href' => $this->url->link('web/extension/account/purpletree_multivendor/blog_post/all_blog','', true)
			);		
			...
			if ($results) {
				...
				foreach($results as $result) {								  
					...
					'href'        => $this->url->link('web/extension/account/purpletree_multivendor/blog_post', 'blog_post_id=' . $result['blog_post_id'])
					);
				}		
				$data['text_readmore'] = $this->language->get('text_readmore');
				...
				$pagination->url = $this->url->link('web/extension/purpletree_blog/blog_post', 'page={page}');
				...
				$this->response->setOutput($this->load->view('web/account/purpletree_multivendor/blog_posts', $data)); 
				} else {
				$data['breadcrumbs'][] = array(
				'text' => $this->language->get('text_error'),
				'href' => $this->url->link('web/extension/account/purpletree_multivendor/blog_post/all_blog','',true)
