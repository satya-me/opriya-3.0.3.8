<?php
class ControllerWebExtensionAccountPurpletreeMultivendorSellercommission extends Controller{
		public function index(){
			...
			if (!$this->customer->isLogged()) {			
				$this->session->data['redirect'] = $this->url->link('web/extension/account/purpletree_multivendor/sellercommission', '', true);
			...
			'href' => $this->url->link('web/extension/account/purpletree_multivendor/sellercommission', '', true)
			);
			...
			$pagination->url = $this->url->link('web/extension/account/purpletree_multivendor/sellercommission', $url . '&page={page}', true);
			...
			$this->response->setOutput($this->load->view('web/account/purpletree_multivendor/commission_list', $data));
		}
	}
?>