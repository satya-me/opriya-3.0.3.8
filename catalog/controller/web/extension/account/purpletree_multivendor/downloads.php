<?php
class ControllerWebExtensionAccountPurpletreeMultivendorDownloads extends Controller {
		private $error = array();
		
		public function index() {
			if (!$this->customer->isLogged()) {
				$this->session->data['redirect'] = $this->url->link('web/extension/account/purpletree_multivendor/downloads', '', true);
		...
		public function add() {
			...
			if(!$this->customer->validateSeller()) {
				...
				$this->response->redirect($this->url->link('web/extension/account/purpletree_multivendor/downloads', '', true));
			}
			$this->load->language('purpletree_multivendor/downloads');
			...
			if (($this->request->server['REQUEST_METHOD'] == 'POST') && $this->validateForm()) {
				...
				$this->response->redirect($this->url->link('web/extension/account/purpletree_multivendor/downloads',  $url, true));
			}
		...
		protected function getList() {
			...
			'href' => $this->url->link('web/extension/account/purpletree_multivendor/downloads',  $url, true)
			);
			$this->load->model('extension/purpletree_multivendor/dashboard');
			$this->model_extension_purpletree_multivendor_dashboard->checkSellerApproval();
			$data['add'] = $this->url->link('web/extension/account/purpletree_multivendor/downloads/add',  $url, true);
			$data['delete'] = $this->url->link('web/extension/account/purpletree_multivendor/downloads/delete',  $url, true);
			...
			foreach ($results as $result) {
				...
				'edit'        => $this->url->link('web/extension/account/purpletree_multivendor/downloads/edit',  '&download_id=' . $result['download_id'] . $url, true)
				);
			}
			...
			$data['sort_name'] = $this->url->link('web/extension/account/purpletree_multivendor/downloads',  'sort=dd.name' . $url, true);
			$data['sort_date_added'] = $this->url->link('web/extension/account/purpletree_multivendor/downloads',  'sort=d.date_added' . $url, true);
			...
			$pagination->url = $this->url->link('web/extension/account/purpletree_multivendor/downloads',  $url . '&page={page}', true);
			...
			$this->response->setOutput($this->load->view('web/account/purpletree_multivendor/downloads_list', $data));
		}
		...
		protected function getForm() {
			...
			if (!isset($this->request->get['download_id'])) {
				$data['action'] = $this->url->link('web/extension/account/purpletree_multivendor/downloads/add',  $url, true);
				} else {
				$data['action'] = $this->url->link('web/extension/account/purpletree_multivendor/downloads/edit',  '&download_id=' . $this->request->get['download_id'] . $url, true);
			}
			$this->load->model('extension/purpletree_multivendor/dashboard');
			$this->model_extension_purpletree_multivendor_dashboard->checkSellerApproval();
			
			$data['cancel'] = $this->url->link('web/extension/account/purpletree_multivendor/downloads',  $url, true);
			...
			$this->response->setOutput($this->load->view('web/account/purpletree_multivendor/downloads_form', $data));
		}
