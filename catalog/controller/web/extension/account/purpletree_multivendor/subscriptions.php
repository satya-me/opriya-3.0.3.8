<?php
class ControllerWebExtensionAccountPurpletreeMultivendorSubscriptions extends Controller {
		private $error = array();
		...
		public function index() {
			...
			if (!$this->customer->isLogged()) {
				$this->session->data['redirect'] = $this->url->link('web/extension/account/purpletree_multivendor/subscriptions', '', true);
		...
		protected function getList() {
			...
			'href' => $this->url->link('web/extension/account/purpletree_multivendor/subscriptions', '' . $url, true)
			);	
			...
			foreach ($results as $result) {
				...
				'view'           => $this->url->link('web/extension/account/purpletree_multivendor/subscriptionplan/invoice', '' . 'invoice_id=' . $result['invoice_id'] , true)
				);
			}
			...
			$pagination->url = $this->url->link('web/extension/account/purpletree_multivendor/subscriptions', '' . $url . '&page={page}', true);
			...
			$this->response->setOutput($this->load->view('web/account/purpletree_multivendor/subscriptions_list', $data));
		}
