<?php
class ControllerWebExtensionAccountPurpletreeMultivendorSellerorder extends Controller{
		private $error = array();
		...
		public function index(){
			...
			if (!$this->customer->isLogged()) {
				$this->session->data['redirect'] = $this->url->link('web/extension/account/purpletree_multivendor/sellerorder', '', true);
			...
			'href' => $this->url->link('web/extension/account/purpletree_multivendor/sellerorder', $url, true)
			);
			...
			foreach ($results as $result) {
				...
				'view'          => $this->url->link('web/extension/account/purpletree_multivendor/sellerorder/seller_order_info', 'order_id=' . $result['order_id'] . $url, true)
				);
			}
			...
			$pagination->url = $this->url->link('web/extension/account/purpletree_multivendor/sellerorder','seller_store_id=' . $sellerstore['id'] . $url . '&page={page}', true);
			...
			$this->response->setOutput($this->load->view('web/account/purpletree_multivendor/seller_order_list', $data));
		}	
		...
		public function seller_order_info(){
			...
			if(!$this->customer->validateSeller()) {
				$this->load->language('purpletree_multivendor/ptsmultivendor');
				$this->session->data['error_warning'] = $this->language->get('error_license');
				$this->response->redirect($this->url->link('web/extension/account/purpletree_multivendor/sellerorder', '', true));
			}
			...
			if ($order_info) { 
				...
				$data['shipping'] = $this->url->link('web/extension/account/purpletree_multivendor/sellerorder/shipping', 'order_id=' . (int)$this->request->get['order_id'], true);
				$data['invoice'] = $this->url->link('web/extension/account/purpletree_multivendor/sellerorder/invoice', 'order_id=' . (int)$this->request->get['order_id'], true);
				...
				$data['store_url'] = $this->url->link('web/extension/account/purpletree_multivendor/sellerstore/storeview','seller_store_id='.$seller_store['id'],true);
				...
				if ($order_info['customer_id']) {
					$data['customer'] = $this->url->link('web/customer/customer/edit', 'customer_id=' . $order_info['customer_id'], true);
					} else {
					$data['customer'] = '';
				}
				...
				foreach ($products as $product) {
					...
					foreach ($options as $option) {
						if ($option['type'] != 'file') {
							...
							if ($upload_info) {
								...
								'type'  => $option['type'],
								'href'  => $this->url->link('web/tool/upload/download', 'code=' . $upload_info['code'], true)
								);
							}
						}
					}
					...
					'seller_href'		=> $this->url->link('web/customer/customer/edit', 'customer_id=' . $product['seller_id'], true),
					'price'    		   => $this->currency->format($product['price'] + ($this->config->get('config_tax') ? $product['tax'] : 0), $order_info['currency_code'], $order_info['currency_value']),
					'total'    		   => $this->currency->format($product['total'] + ($this->config->get('config_tax') ? ($product['tax'] * $product['quantity']) : 0), $order_info['currency_code'], $order_info['currency_value']),
					'href'     		   => $this->url->link('web/product/product','product_id=' . $product['product_id'], true)
					);
				}
				...
				foreach ($vouchers as $voucher) {
					...
					'href'        => $this->url->link('web/sale/voucher/edit', 'voucher_id=' . $voucher['voucher_id'], true)
					);
				}
				...
				if ($order_info['affiliate_id']) {
					$data['affiliate'] = $this->url->link('web/marketing/affiliate/edit', 'affiliate_id=' . $order_info['affiliate_id'], true);
					} else {
					$data['affiliate'] = '';
				}
			...
			$this->response->setOutput($this->load->view('web/account/purpletree_multivendor/order_info', $data));
		}
		...
		public function invoice() {
			...
			$this->response->setOutput($this->load->view('web/account/purpletree_multivendor/order_invoice', $data));
		}
		...
		public function shipping() {
			...
			$data['HTTPS_SERVER'] = HTTPS_SERVER;
			$this->response->setOutput($this->load->view('web/account/purpletree_multivendor/order_shipping', $data));
		}
		...
		public function historylist() {
			...
			$pagination->url = $this->url->link('web/extension/account/purpletree_multivendor/sellerorder/historylist', $url . '&page={page}',true);
			...
			if ($page == 1) {
				$this->document->addLink($this->url->link('web/extension/account/purpletree_multivendor/sellerorder/historylist', '', true), 'canonical');
				} elseif ($page == 2) {
				$this->document->addLink($this->url->link('web/extension/account/purpletree_multivendor/sellerorder/historylist', '', true), 'prev');
				} else {
				$this->document->addLink($this->url->link('web/extension/account/purpletree_multivendor/sellerorder/historylist', 'page='. ($page - 1), true), 'prev');
			}
			
			if ($limit && ceil($history_total / $limit) > $page) {
				$this->document->addLink($this->url->link('web/extension/account/purpletree_multivendor/sellerorder/historylist', 'page='. ($page + 1), true), 'next');
			}
			
			$this->response->setOutput($this->load->view('web/account/purpletree_multivendor/order_history', $data));
