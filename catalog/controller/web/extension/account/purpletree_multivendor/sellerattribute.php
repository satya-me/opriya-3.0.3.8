<?php
class ControllerWebExtensionAccountPurpletreeMultivendorSellerattribute extends Controller {
		private $error = array();
		...
		public function add() {
			...
			if (($this->request->server['REQUEST_METHOD'] == 'POST') && $this->validateForm()) {
				...
				$this->response->redirect($this->url->link('web/extension/account/purpletree_multivendor/sellerattribute', '', true));
			}
		...
		protected function getList() {
			...
			'href' => $this->url->link('web/extension/account/purpletree_multivendor/sellerattribute',  $url, true)
			);
			$this->load->model('extension/purpletree_multivendor/dashboard');
			
			$this->model_extension_purpletree_multivendor_dashboard->checkSellerApproval();
			
			$data['add'] = $this->url->link('web/extension/account/purpletree_multivendor/sellerattribute/add', '',true);
			$data['delete'] = $this->url->link('web/extension/account/purpletree_multivendor/sellerattribute/delete', '',true);
			...
			foreach ($results as $result) {
				...
				'edit'       => $this->url->link('web/extension/account/purpletree_multivendor/sellerattribute/edit', '&attribute_id=' . $result['id'].$url, true)
				);
			}
			...
			$data['sort_name'] = $this->url->link('web/extension/account/purpletree_multivendor/sellerattribute' , $url, true);
			$data['sort_code'] = $this->url->link('web/extension/account/purpletree_multivendor/sellerattribute',  '&sort=code' . $url, true);
			$data['sort_discount'] = $this->url->link('web/extension/account/purpletree_multivendor/sellerattribute', '&sort=discount' . $url, true);
			$data['sort_date_start'] = $this->url->link('web/extension/account/purpletree_multivendor/sellerattribute', '&sort=date_start' . $url, true);
			$data['sort_date_end'] = $this->url->link('web/extension/account/purpletree_multivendor/sellerattribute', '&sort=date_end' . $url, true);
			$data['sort_status'] = $this->url->link('web/extension/account/purpletree_multivendor/sellerattribute', '&sort=status' . $url, true);
			...
			$pagination->url = $this->url->link('web/extension/account/purpletree_multivendor/sellerattribute', '' . $url . '&page={page}', true);
			...
			$this->response->setOutput($this->load->view('web/account/purpletree_multivendor/attribute_list', $data));
		}
		...
		protected function getForm() {
			...
			$data['breadcrumbs'][] = array(
			'text' => $this->language->get('heading_title'),
			'href' => $this->url->link('web/extension/account/purpletree_multivendor/sellertemplateproduct',  $url, true)
			);
			$this->load->model('extension/purpletree_multivendor/dashboard');
			...
			if (!isset($this->request->get['attribute_id'])) {
				$data['action'] = $this->url->link('web/extension/account/purpletree_multivendor/sellerattribute/add', '',true);
				} else {
				$data['action'] = $this->url->link('web/extension/account/purpletree_multivendor/sellerattribute/edit','&attribute_id=' . $this->request->get['attribute_id'] , true);
			}
			$data['cancel'] = $this->url->link('web/extension/account/purpletree_multivendor/sellerattribute','', true);
			...
			$this->response->setOutput($this->load->view('web/account/purpletree_multivendor/attribute_form', $data));
		}
		...
		public function history() {
			...
			$pagination->page = $page;
			$pagination->limit = 10;
			$pagination->url = $this->url->link('web/extension/account/purpletree_multivendor/sellerattribute/history', $url . '&page={page}', true);
			...
			$this->response->setOutput($this->load->view('web/account/purpletree_multivendor/coupon_history', $data));
		}
	}
?>