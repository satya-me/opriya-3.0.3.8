<?php
class ControllerWebExtensionAccountPurpletreeMultivendorProductReturns extends Controller {
		private $error = array();
		...
		public function edit() {
			...
			if (($this->request->server['REQUEST_METHOD'] == 'POST') && $this->validateForm()) {
				...
				$this->response->redirect($this->url->link('web/extension/account/purpletree_multivendor/product_returns',$url, true));
			}
		...
		protected function getList() {
			...
			'href' => $this->url->link('web/extension/account/purpletree_multivendor/product_returns', $url, true)
			);
			$data['heading_title'] = $this->language->get('heading_title');
			$data['text_all'] = $this->language->get('text_all');
			$data['add'] = $this->url->link('web/extension/account/purpletree_multivendor/product_returns/add', $url, true);
			$data['delete'] = $this->url->link('web/extension/account/purpletree_multivendor/product_returns/delete', $url, true);
			...
			foreach ($results as $result) {
				...
				'edit'          => $this->url->link('web/extension/account/purpletree_multivendor/product_returns/edit','&return_id=' . $result['return_id'] . $url, true)
				);
			}
			...
			$data['sort_return_id'] = $this->url->link('web/extension/account/purpletree_multivendor/product_returns', $url, true);
			$data['sort_order_id'] = $this->url->link('web/extension/account/purpletree_multivendor/product_returns', $url, true);
			$data['sort_customer'] = $this->url->link('web/extension/account/purpletree_multivendor/product_returns', $url, true);
			$data['sort_product'] = $this->url->link('web/extension/account/purpletree_multivendor/product_returns', $url, true);
			$data['sort_model'] = $this->url->link('web/extension/account/purpletree_multivendor/product_returns', $url, true);
			$data['sort_status'] = $this->url->link('web/extension/account/purpletree_multivendor/product_returns', $url, true);
			$data['sort_date_added'] = $this->url->link('web/extension/account/purpletree_multivendor/product_returns', $url, true);
			$data['sort_date_modified'] = $this->url->link('web/extension/account/purpletree_multivendor/product_returns', $url, true);
			...
			$pagination->url = $this->url->link('web/extension/account/purpletree_multivendor/product_returns', $url . '&page={page}', true);
			...
			$this->response->setOutput($this->load->view('web/account/purpletree_multivendor/product_returns_list', $data));
		}
		...
		protected function getForm() {
			...
			$data['action'] = $this->url->link('web/extension/account/purpletree_multivendor/product_returns/edit','&return_id=' . $this->request->get['return_id'] . $url, true);
			
			
			$data['cancel'] = $this->url->link('web/extension/account/purpletree_multivendor/product_returns', $url, true);
			...
			$this->response->setOutput($this->load->view('web/account/purpletree_multivendor/product_return_form', $data));
		}
		...
		public function history() {
			...
			$pagination->page = $page;
			$pagination->limit = 10;
			$pagination->url = $this->url->link('web/extension/account/purpletree_multivendor/product_returns/history', '&return_id=' . $this->request->get['return_id'] . '&page={page}', true);
			$data['pagination'] = $pagination->render();
			$data['results'] = sprintf($this->language->get('text_pagination'), ($history_total) ? (($page - 1) * 10) + 1 : 0, ((($page - 1) * 10) > ($history_total - 10)) ? $history_total : ((($page - 1) * 10) + 10), $history_total, ceil($history_total / 10));
			$this->response->setOutput($this->load->view('web/account/purpletree_multivendor/product_return_history', $data));
		}
