<?php
class ControllerWebExtensionAccountPurpletreeMultivendorSellerattributegroups extends Controller {
		private $error = array();
		...
		public function add() {
			...
			if (($this->request->server['REQUEST_METHOD'] == 'POST') && $this->validateForm()) {
				...
				$this->response->redirect($this->url->link('web/extension/account/purpletree_multivendor/sellerattributegroups', '', true));
			}
		...
		protected function getList() {
			...
			'href' => $this->url->link('web/extension/account/purpletree_multivendor/sellerattributegroups',  $url, true)
			);
			$this->load->model('extension/purpletree_multivendor/dashboard');
			
			$this->model_extension_purpletree_multivendor_dashboard->checkSellerApproval();
			
			$data['add'] = $this->url->link('web/extension/account/purpletree_multivendor/sellerattributegroups/add', '',true);
			$data['delete'] = $this->url->link('web/extension/account/purpletree_multivendor/sellerattributegroups/delete', '',true);
			...
			if(!empty($results)){
				foreach ($results as $result) {
					...
					'edit'       => $this->url->link('web/extension/account/purpletree_multivendor/sellerattributegroups/edit', '&attribute_group_id=' . $result['attribute_group_id'].$url, true)
					);
				}
			}
			...
			$data['sort_name'] = $this->url->link('web/extension/account/purpletree_multivendor/sellerattributegroups' , $url, true);
			$data['sort_code'] = $this->url->link('web/extension/account/purpletree_multivendor/sellerattributegroups',  '&sort=code' . $url, true);
			$data['sort_discount'] = $this->url->link('web/extension/account/purpletree_multivendor/sellerattributegroups', '&sort=discount' . $url, true);
			$data['sort_date_start'] = $this->url->link('web/extension/account/purpletree_multivendor/sellerattributegroups', '&sort=date_start' . $url, true);
			$data['sort_date_end'] = $this->url->link('web/extension/account/purpletree_multivendor/sellerattributegroups', '&sort=date_end' . $url, true);
			$data['sort_status'] = $this->url->link('web/extension/account/purpletree_multivendor/sellerattributegroups', '&sort=status' . $url, true);
			...
			$pagination->url = $this->url->link('web/extension/account/purpletree_multivendor/sellerattributegroups', '' . $url . '&page={page}', true);
			...
			$this->response->setOutput($this->load->view('web/account/purpletree_multivendor/attribute_groups_list', $data));
		}
		...
		protected function getForm() {
			...
			if (!isset($this->request->get['attribute_group_id'])) {
				$data['action'] = $this->url->link('web/extension/account/purpletree_multivendor/sellerattributegroups/add', '',true);
				} else {
				$data['action'] = $this->url->link('web/extension/account/purpletree_multivendor/sellerattributegroups/edit','&attribute_group_id=' . $this->request->get['attribute_group_id'] , true);
			}
			$data['cancel'] = $this->url->link('web/extension/account/purpletree_multivendor/sellerattributegroups','', true);
			...
			$this->response->setOutput($this->load->view('web/account/purpletree_multivendor/attribute_groups_form', $data));
		}
