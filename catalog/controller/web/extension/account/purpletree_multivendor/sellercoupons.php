<?php
class ControllerWebExtensionAccountPurpletreeMultivendorSellercoupons extends Controller {
		private $error = array();
		...
		public function add() {
			...
			if (($this->request->server['REQUEST_METHOD'] == 'POST') && $this->validateForm()) {
				...
				$this->response->redirect($this->url->link('web/extension/account/purpletree_multivendor/sellercoupons', '', true));
			}
		...
		protected function getList() {
			...
			'href' => $this->url->link('web/extension/account/purpletree_multivendor/sellercoupons',  $url, true)
			);
			...
			$data['add'] = $this->url->link('web/extension/account/purpletree_multivendor/sellercoupons/add', '',true);
			$data['delete'] = $this->url->link('web/extension/account/purpletree_multivendor/sellercoupons/delete', '',true);
			...
			foreach ($results as $result) {
				...
				'edit'       => $this->url->link('web/extension/account/purpletree_multivendor/sellercoupons/edit', '&coupon_id=' . $result['coupon_id'].$url, true)
				);
			}
			...
			$data['sort_name'] = $this->url->link('web/extension/account/purpletree_multivendor/sellercoupons' , $url, true);
			$data['sort_code'] = $this->url->link('web/extension/account/purpletree_multivendor/sellercoupons',  '&sort=code' . $url, true);
			$data['sort_discount'] = $this->url->link('web/extension/account/purpletree_multivendor/sellercoupons', '&sort=discount' . $url, true);
			$data['sort_date_start'] = $this->url->link('web/extension/account/purpletree_multivendor/sellercoupons', '&sort=date_start' . $url, true);
			$data['sort_date_end'] = $this->url->link('web/extension/account/purpletree_multivendor/sellercoupons', '&sort=date_end' . $url, true);
			$data['sort_status'] = $this->url->link('web/extension/account/purpletree_multivendor/sellercoupons', '&sort=status' . $url, true);
			...
			$pagination->url = $this->url->link('web/extension/account/purpletree_multivendor/sellercoupons', '' . $url . '&page={page}', true);
			...
			$this->response->setOutput($this->load->view('web/account/purpletree_multivendor/coupon_list', $data));
		}
		...
		protected function getForm() {
			...
			if (!isset($this->request->get['coupon_id'])) {
				$data['action'] = $this->url->link('web/extension/account/purpletree_multivendor/sellercoupons/add', '',true);
				} else {
				$data['action'] = $this->url->link('web/extension/account/purpletree_multivendor/sellercoupons/edit','&coupon_id=' . $this->request->get['coupon_id'] , true);
			}
			$data['cancel'] = $this->url->link('web/extension/account/purpletree_multivendor/sellercoupons','', true);
			...
			$this->response->setOutput($this->load->view('web/account/purpletree_multivendor/coupon_form', $data));
		}
		...
		public function history() {
			...
			$pagination->page = $page;
			$pagination->limit = 10;
			$pagination->url = $this->url->link('web/extension/account/purpletree_multivendor/sellercoupons/history', $url . '&page={page}', true);
