<?php
class ControllerWebExtensionAccountPurpletreeMultivendorSellertemplateproduct extends Controller{
		...
		public function index(){
			...
			if (!$this->customer->isLogged()) {
				$this->session->data['redirect'] = $this->url->link('web/extension/account/purpletree_multivendor/sellertemplateproduct', '', true);
		...
		public function edit() {
			...
			if(!$this->customer->validateSeller()) {
				$this->load->language('purpletree_multivendor/ptsmultivendor');
				$this->session->data['error_warning'] = $this->language->get('error_license');			
				$this->response->redirect($this->url->link('web/extension/account/purpletree_multivendor/sellertemplateproduct', '', true));
			}
		...
		protected function getForm() {
			...
			$data['action'] = $this->url->link('web/extension/account/purpletree_multivendor/sellertemplateproduct/edit','&id=' . $this->request->get['id'].'&template_id=' . $this->request->get["template_id"] , true);		
			$seller_id = $this->customer->getId();
			$data['cancel'] = $this->url->link('web/extension/account/purpletree_multivendor/sellertemplateproduct','', true);
			...
			$data['back'] = $this->url->link('web/extension/account/purpletree_multivendor/sellertemplateproduct', '', true);
			...
			$this->response->setOutput($this->load->view('web/account/purpletree_multivendor/templateproduct_form', $data));
		...
		protected function getList(){
			...
			$data['delete'] = $this->url->link('web/extension/account/purpletree_multivendor/sellertemplateproduct/delete', $url, true);
			...
			foreach ($results as $result) {
				...
				'edit'       => $this->url->link('web/extension/account/purpletree_multivendor/sellertemplateproduct/edit','id=' . $result["seller_template_id"].'&template_id=' . $result["id"].$url, true),
				'delete'       => $this->url->link('web/extension/account/purpletree_multivendor/sellertemplateproduct/delete','id=' . $result['seller_template_id'].'&template_id=' . $result["id"].$url, true)
				);
			}
			...
			$pagination->url = $this->url->link('web/extension/account/purpletree_multivendor/sellertemplateproduct', $url . '&page={page}', true);
			...
			$this->response->setOutput($this->load->view('web/account/purpletree_multivendor/templateproduct_list', $data));
