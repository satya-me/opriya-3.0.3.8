<?php
class ControllerWebExtensionAccountPurpletreeMultivendorApiSellerproduct extends Controller{
		private $error = array();
		private $json = array();
		...
		public function Productform(){
			...
			if (!empty($product_infoq)) {
				...
				} elseif(isset($this->request->get['upc'])) {
				$json['data']['upc'] = $this->request->get['upc'];
				} else {
				$json['data']['upc'] = '';
			}
			if (!empty($product_infoq)) {
