<?php
class ControllerWebExtensionAccountPurpletreeMultivendorSelleroptions extends Controller {
		private $error = array();
		...
		public function add() {
			...
			if (($this->request->server['REQUEST_METHOD'] == 'POST') && $this->validateForm()) {
				...
				$this->response->redirect($this->url->link('web/extension/account/purpletree_multivendor/selleroptions', '', true));
			}
		...
		protected function getList() {
			...
			'href' => $this->url->link('web/extension/account/purpletree_multivendor/selleroptions',  $url, true)
			);
			$this->load->model('extension/purpletree_multivendor/dashboard');
			
			$this->model_extension_purpletree_multivendor_dashboard->checkSellerApproval();
			
			$data['add'] = $this->url->link('web/extension/account/purpletree_multivendor/selleroptions/add', '',true);
			$data['delete'] = $this->url->link('web/extension/account/purpletree_multivendor/selleroptions/delete', '',true);
			...
			if(!empty($results)){
				foreach ($results as $result) {
					...
					'edit'       => $this->url->link('web/extension/account/purpletree_multivendor/selleroptions/edit', '&option_id=' . $result['option_id'].$url, true)
					);
				}
			}
			...
			$data['sort_name'] = $this->url->link('web/extension/account/purpletree_multivendor/selleroptions' , $url, true);
			$data['sort_code'] = $this->url->link('web/extension/account/purpletree_multivendor/selleroptions',  '&sort=code' . $url, true);
			$data['sort_discount'] = $this->url->link('web/extension/account/purpletree_multivendor/selleroptions', '&sort=discount' . $url, true);
			$data['sort_date_start'] = $this->url->link('web/extension/account/purpletree_multivendor/selleroptions', '&sort=date_start' . $url, true);
			$data['sort_date_end'] = $this->url->link('web/extension/account/purpletree_multivendor/selleroptions', '&sort=date_end' . $url, true);
			$data['sort_status'] = $this->url->link('web/extension/account/purpletree_multivendor/selleroptions', '&sort=status' . $url, true);
			...
			$pagination->url = $this->url->link('web/extension/account/purpletree_multivendor/selleroptions', '' . $url . '&page={page}', true);
			...
			$this->response->setOutput($this->load->view('web/account/purpletree_multivendor/options_list', $data));
		}
		...
		protected function getForm() {
			...
			if (!isset($this->request->get['option_id'])) {
				$data['action'] = $this->url->link('web/extension/account/purpletree_multivendor/selleroptions/add', '',true);
				} else {
				$data['action'] = $this->url->link('web/extension/account/purpletree_multivendor/selleroptions/edit','&option_id=' . $this->request->get['option_id'] , true);
			}
			$data['cancel'] = $this->url->link('web/extension/account/purpletree_multivendor/selleroptions','', true);
			...
			$this->response->setOutput($this->load->view('web/account/purpletree_multivendor/options_form', $data));
		}
