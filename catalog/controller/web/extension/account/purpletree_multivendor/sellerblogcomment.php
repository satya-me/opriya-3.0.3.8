<?php
class ControllerWebExtensionAccountPurpletreeMultivendorSellerblogcomment extends Controller {
		private $error = array();
		
		public function index() {
			if (!$this->customer->isLogged()) {
				$this->session->data['redirect'] = $this->url->link('web/extension/account/purpletree_multivendor/sellerblogcomment', '', true);
		...
		public function edit() {
			...
			if(!$this->customer->validateSeller()) {
				...
				$this->response->redirect($this->url->link('web/extension/account/purpletree_multivendor/sellerblogcomment', '', true));
			}
			$this->load->language('purpletree_multivendor/sellerblogcomment');
		...
		protected function getList() {
			...
			'href' => $this->url->link('web/extension/account/purpletree_multivendor/sellerblogcomment', $url, true)
			);		
			
			
			$data['delete'] = $this->url->link('web/extension/account/purpletree_multivendor/sellerblogcomment/delete',$url, true);
			...
			foreach ($results as $result) {
				...
				'edit'       => $this->url->link('web/extension/account/purpletree_multivendor/sellerblogcomment/edit', '&comment_id=' . $result['blog_comment_id'] . $url, true)
				);
			}
			...
			$pagination->url = $this->url->link('web/extension/account/purpletree_multivendor/sellerblogcomment',$url . '&page={page}', true);
			...
			$this->response->setOutput($this->load->view('web/account/purpletree_multivendor/sellerblogcomment_list', $data));
		}
		...
		protected function getForm() {
			...
			if (!isset($this->request->get['comment_id'])) {
				$data['action'] = $this->url->link('web/extension/account/purpletree_multivendor/sellerblogcomment/add', $url, true);
				} else {
				$data['action'] = $this->url->link('web/extension/account/purpletree_multivendor/sellerblogcomment/edit', $url, true);
			}
			
			$data['cancel'] = $this->url->link('web/extension/account/purpletree_multivendor/sellerblogcomment', $url, true);
			...
			$this->response->setOutput($this->load->view('web/account/purpletree_multivendor/sellerblogcomment_form', $data));
		}
