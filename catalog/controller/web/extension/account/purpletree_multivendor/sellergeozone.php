<?php
class ControllerWebExtensionAccountPurpletreeMultivendorSellergeozone extends Controller {
		private $error = array();
		...
		public function add() {
			...
			if (($this->request->server['REQUEST_METHOD'] == 'POST') && $this->validateForm()) {
				...
				$this->response->redirect($this->url->link('web/extension/account/purpletree_multivendor/sellergeozone', '', true));
			}
			$this->getForm();
		}
		...
		protected function getList() {
			...
			'href' => $this->url->link('web/extension/account/purpletree_multivendor/sellergeozone', $url, true)
			);
			$this->load->model('extension/purpletree_multivendor/dashboard');
			
			$this->model_extension_purpletree_multivendor_dashboard->checkSellerApproval();
			
			$data['add'] = $this->url->link('web/extension/account/purpletree_multivendor/sellergeozone/add', $url, true);
			
			$data['delete'] = $this->url->link('web/extension/account/purpletree_multivendor/sellergeozone/delete', '',true);
			...
			foreach ($results as $result) {
				...
				'edit'       => $this->url->link('web/extension/account/purpletree_multivendor/sellergeozone/edit', '&geo_zone_id=' . $result['geo_zone_id'].$url, true)
				);
			}
			...
			$data['sort_name'] = $this->url->link('web/extension/purpletree_multivendor/sellergeozone',  '&sort=code' . $url, true);
			$data['sort_description'] = $this->url->link('web/extension/purpletree_multivendor/sellergeozone',  '&sort=code' . $url, true);
			...
			$pagination->url = $this->url->link('web/extension/account/purpletree_multivendor/sellergeozone', '' . $url . '&page={page}', true);
			...
			$this->response->setOutput($this->load->view('web/account/purpletree_multivendor/geo_zone_list', $data));	
		}
		...
		protected function getForm() {
			...
			if (!isset($this->request->get['geo_zone_id'])) {
				$data['action'] = $this->url->link('web/extension/account/purpletree_multivendor/sellergeozone/add', $url, true);
				} else {
				$data['action'] = $this->url->link('web/extension/account/purpletree_multivendor/sellergeozone/edit', '&geo_zone_id=' . $this->request->get['geo_zone_id'] . $url, true);
			}
			$data['cancel'] = $this->url->link('web/extension/account/purpletree_multivendor/sellergeozone','', true);
			...
			$this->response->setOutput($this->load->view('web/account/purpletree_multivendor/geo_zone_form', $data));
		}
