<?php
class ControllerWebExtensionAccountPurpletreeMultivendorSellercontact extends Controller {
		private $error = array();
		...
		protected function validatemessage() {
			...
			if ($this->config->get($this->config->get('config_captcha') . '_status') && in_array('contact', (array)$this->config->get('config_captcha_page'))) {
				$captcha = $this->load->controller('web/captcha/' . $this->config->get('config_captcha') . '/validate');
		...
		public function customerContactlist(){
			...
			$this->response->setOutput($this->load->view('web/account/purpletree_multivendor/customercontactlist', $data));
		}
		...
		public function sellercontactlist(){
			...
			if($this->customer->isSeller()){
				...
				$this->response->setOutput($this->load->view('web/account/purpletree_multivendor/contactlist', $data));
				} else {
		...
		public function reply() {
			...
			// Captcha
			$data['captcha'] = $this->load->controller('web/captcha/' . $this->config->get('config_captcha'), $this->error);
			...
			$this->response->setOutput($this->load->view('web/account/purpletree_multivendor/customer_reply', $data));
		}
		...
		public function customerReply() {
			...
			if(strpos($_SERVER['SERVER_PROTOCOL'],'https')==true){$proto='https://';} else {$proto='http://';}
			...
			$this->response->setOutput($this->load->view('web/account/purpletree_multivendor/seller_reply', $data));
		}
