<?php
class ControllerWebExtensionAccountPurpletreeMultivendorSellerproduct extends Controller
{
    private $error = array();
    ...
    public function index()
    {
        if (!$this->customer->isLogged()) {
            $this->session->data['redirect'] = $this->url->link('web/extension/account/purpletree_multivendor/sellerproduct', '', true);
    ...
    public function add()
    {
        ...
        if (!$this->customer->validateSeller()) {
            ...
            $this->response->redirect($this->url->link('web/extension/account/purpletree_multivendor/sellerproduct', '', true));
        }
        ...
        if (($this->request->server['REQUEST_METHOD'] == 'POST')) {
            ...
            if ($this->validateForm()) {
                    ...
                    if (isset($this->request->post['is_featured'])) {
                        if ($this->request->post['is_featured'] == 1) {
                            if ($allowed_featured_product > $total_featured_product) {} else {
                                ...
                                $this->response->redirect($this->url->link('web/extension/account/purpletree_multivendor/sellerproduct/add', '', true));
                            }
                        }
                    }
                ...
                $this->response->redirect($this->url->link('web/extension/account/purpletree_multivendor/sellerproduct', $url, true));
            }
        }
                    ...
                    if (isset($this->request->post['is_featured'])) {
                        if ($this->request->post['is_featured'] == 1 && $is_featuredproduct != 1) {
                            if ($allowed_featured_product > $total_featured_product) {} else {
                                ...
                                $this->response->redirect($this->url->link('web/extension/account/purpletree_multivendor/sellerproduct/edit', '&product_id=' . $this->request->get['product_id'], true));
                            }
                        }
                    }
                    ////////////
    ...
    protected function getForm()
    {
        ...
        $data['breadcrumbs'][] = array(
            ...
            'href' => $this->url->link('web/extension/account/purpletree_multivendor/sellerproduct', $url, true),
        );
        $seller_id = $this->customer->getId();
        ...
        if (!isset($this->request->get['product_id'])) {
            $data['action'] = $this->url->link('web/extension/account/purpletree_multivendor/sellerproduct/add', $url, true);
        } else {
            $data['action'] = $this->url->link('web/extension/account/purpletree_multivendor/sellerproduct/edit', '&product_id=' . $this->request->get['product_id'] . $url, true);
        }
        $seller_id = $this->customer->getId();
        $data['cancel'] = $this->url->link('web/extension/account/purpletree_multivendor/sellerproduct', $url, true);
        ...
        $data['back'] = $this->url->link('web/extension/account/purpletree_multivendor/sellerproduct', '', true);
        ...
        if ($this->config->get('module_purpletree_multivendor_hide_seller_product_tab')) {
            $this->response->setOutput($this->load->view('web/account/purpletree_multivendor/product_form_hideninfo', $data));
        } else {
            $this->response->setOutput($this->load->view('web/account/purpletree_multivendor/product_form', $data));
        }
    }
    ...
    protected function getList()
    {
        ...
        $data['sorts_order'][] = array(
            ...
            'value' => 'ASC',
            'href' => $this->url->link('web/extension/account/purpletree_multivendor/sellerproduct', '&order=ASC' . $url, true),
        );

        $data['sorts_order'][] = array(
            'text' => $this->language->get('text_name_desc'),
            'value' => 'DESC',
            'href' => $this->url->link('web/extension/account/purpletree_multivendor/sellerproduct', '&order=DESC' . $url, true),
        );
        ...
        $data['enabledproduct'] = $this->url->link('web/extension/account/purpletree_multivendor/sellerproduct/enabledproduct', $url, true);

        $data['disabledproduct'] = $this->url->link('web/extension/account/purpletree_multivendor/sellerproduct/disabledproduct', $url, true);
        ...
        if ($this->config->get('module_purpletree_multivendor_subscription_plans')) {
            ...
            if (isset($plan_product)) {
                ...
                if ($plan_product > $store_product) {
                    ...
                    $data['add'] = $this->url->link('web/extension/account/purpletree_multivendor/sellerproduct/add', $url, true);
                    $data['copy'] = $this->url->link('web/extension/account/purpletree_multivendor/sellerproduct/copy', $url, true);

                } else {
                    //$this->session->data['error_warning']=$this->language->get('error_subscription_plan_limit');

                    $data['add'] = $this->url->link('web/extension/account/purpletree_multivendor/sellerproduct', $url, true);
                    $data['copy'] = $this->url->link('web/extension/account/purpletree_multivendor/sellerproduct', $url, true);
        ...
        $data['delete'] = $this->url->link('web/extension/account/purpletree_multivendor/sellerproduct/delete', $url, true);
        ...
        foreach ($results as $result) {
            ...
            $price_extra = 0;
            if ($result['price_extra_type'] == 1) {$price_extra = $result['price_extra'];} elseif ($result['price_extra_type'] == 2) {$price_extra = $result['price'] * $result['price_extra'] / 100;} elseif (!$result['price_extra_type']) {
            ...
            $data['products'][] = array(
                ...
                'hide_edit' => $hide_edit,
                'edit' => $this->url->link('web/extension/account/purpletree_multivendor/sellerproduct/edit', '&product_id=' . $result['product_id'] . $url, true),
            );
        }
        ...
        $pagination->url = $this->url->link('web/extension/account/purpletree_multivendor/sellerproduct', $url . '&page={page}', true);
        ...
        $data['p_edit'] = $this->url->link('web/extension/account/purpletree_multivendor/sellerproduct/edit', $url, true);
        $data['column_left'] = $this->load->controller('web/common/column_left');
        $data['column_right'] = $this->load->controller('web/common/column_right');
        $data['content_top'] = $this->load->controller('web/common/content_top');
        $data['content_bottom'] = $this->load->controller('web/common/content_bottom');
        ...
        $this->response->setOutput($this->load->view('web/account/purpletree_multivendor/product_list', $data));
