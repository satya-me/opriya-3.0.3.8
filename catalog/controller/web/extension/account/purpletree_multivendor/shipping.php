<?php
class ControllerWebExtensionAccountPurpletreeMultivendorShipping extends Controller {
		private $error = array();
		...
		public function index() {
			...
			if (!$this->customer->isLogged()) {
				$this->session->data['redirect'] = $this->url->link('web/extension/account/purpletree_multivendor/shipping', '', true);
		...
		public function add() {
			...
			if(!$this->customer->validateSeller()) {
				...
				$this->response->redirect($this->url->link('web/extension/account/purpletree_multivendor/shipping', '', true));
			}
			...
			if (($this->request->server['REQUEST_METHOD'] == 'POST' && $this->validateForm()) ) {
				...
				$this->response->redirect($this->url->link('web/extension/account/purpletree_multivendor/shipping', '' . $url, true));
			}
		...
		protected function getList() {
			...
			'href' => $this->url->link('web/extension/account/purpletree_multivendor/shipping', '' . $url, true)
			);
			
			$data['add'] = $this->url->link('web/extension/account/purpletree_multivendor/shipping/add', '' . $url, true);
			$data['delete'] = $this->url->link('web/extension/account/purpletree_multivendor/shipping/delete', '' . $url, true);
			...
			foreach ($results as $result) {
				...
				'deletes'           => $this->url->link('web/extension/account/purpletree_multivendor/shipping/deletes', '' . 'shipping_id=' . $result['id'] . $url, true),
				'edit'           => $this->url->link('web/extension/account/purpletree_multivendor/shipping/edit', '' . 'shipping_id=' . $result['id'] . $url, true)
				);
			}
			...
			$data['sort_shipping_country'] = $this->url->link('web/extension/account/purpletree_multivendor/shipping', '' . 'sort=cu.name' . $url, true);
			$data['sort_zip_from'] = $this->url->link('web/extension/account/purpletree_multivendor/shipping', '' . 'sort=pvs.zipcode_from' . $url, true);
			$data['sort_zip_to'] = $this->url->link('web/extension/account/purpletree_multivendor/shipping', '' . 'sort=pvs.zipcode_to' . $url, true);
			$data['sort_price'] = $this->url->link('web/extension/account/purpletree_multivendor/shipping', '' . 'sort=pvs.shipping_price' . $url, true);
			$data['sort_weight_from'] = $this->url->link('web/extension/account/purpletree_multivendor/shipping', '' . 'sort=pvs.weight_from' . $url, true);
			$data['sort_weight_to'] = $this->url->link('web/extension/account/purpletree_multivendor/shipping', '' . 'sort=pvs.weight_to' . $url, true);
			...
			$pagination->url = $this->url->link('web/extension/account/purpletree_multivendor/shipping', '' . $url . '&page={page}', true);
			...
			$data['sort'] = $sort;
			$data['order'] = $order;
			$data['url'] = $this->url->link('web/extension/account/purpletree_multivendor/bulkshippingupload', '', true);	
			...
			$this->response->setOutput($this->load->view('web/account/purpletree_multivendor/shipping_list', $data));
		}
		...
		protected function getForm() {
			...
			$data['cancel'] = $this->url->link('web/extension/account/purpletree_multivendor/shipping', '' . $url, true);
			...
			$data['footer'] = $this->load->controller('web/common/footer');
			$data['header'] = $this->load->controller('web/common/header');
			$this->response->setOutput($this->load->view('web/account/purpletree_multivendor/shipping_form', $data));
		}
