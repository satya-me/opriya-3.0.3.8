<?php
class ControllerWebExtensionAccountPurpletreeMultivendorCommissioninvoice extends Controller{
		private $error = array();
		public function index(){
			...
			if (!$this->customer->isLogged()) {
				$this->session->data['redirect'] = $this->url->link('web/extension/account/purpletree_multivendor/commissioninvoice', '', true);
			...
			'href' => $this->url->link('web/extension/account/purpletree_multivendor/commissioninvoice',$url, true)
			);
			...
			if(!empty($seller_commissions)) {
				foreach($seller_commissions as $invocee) {
					...
					'view' 			=> $this->url->link('web/extension/account/purpletree_multivendor/commissioninvoice/view', '&commision_view_id='.$invocee['id'], true)
					);
				}
			...
			$pagination->url = $this->url->link('web/extension/account/purpletree_multivendor/commissioninvoice',$url . '&page={page}', true);
			...
			$this->response->setOutput($this->load->view('web/account/purpletree_multivendor/commissioninvoice_list', $data));
		}
		public function view(){
			...
			if(!$this->customer->validateSeller()) {
				...
				$this->response->redirect($this->url->link('web/extension/account/purpletree_multivendor/commissioninvoice', '', true));
			}
			$this->load->model('extension/purpletree_multivendor/dashboard');
			$this->model_extension_purpletree_multivendor_dashboard->checkSellerApproval();
			...
			if(!empty($commisionss)) {
				...
				$this->response->redirect($this->url->link('web/extension/purpletree_multivendor/commissioninvoice','',true));
			}
			...
			$this->response->setOutput($this->load->view('web/account/purpletree_multivendor/commison_invoicee', $data));	
		}
	}
?>