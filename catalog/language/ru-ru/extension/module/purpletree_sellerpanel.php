<?php		
$_['text_selleroption']   	=	"Параметры продавца";
$_['text_dashboard']     = 'Резюме';
$_['text_dashboard_icon']     = 'Панель приборов';
...
$_['text_sellerenquiry']   	=	"Запросы клиентов";
...
$_['text_seller_enquiries']   = "Сообщения администратора";
$_['text_seller_template_product']   = 'Шаблоны продуктов';
$_['text_sellercoupons']        = 		"Купоны продавца";
$_['text_seller_returns']               = 			'Возвращает';
$_['text_attribute'] = "Атрибуты продукта";
$_['text_attribute_groups'] = "Группы атрибутов продукта";
$_['text_options'] = "Параметры продукта";
?>		