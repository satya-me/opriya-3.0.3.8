...
class ModelExtensionPurpletreeMultivendorSellerproduct extends Model{
	   ////// quick order //////
					...
					if ($product_option['type'] == 'select' || $product_option['type'] == 'radio' || $product_option['type'] == 'checkbox' || $product_option['type'] == 'image') {
						if (isset($product_option['product_option_value'])) {
							...
							foreach ($product_option['product_option_value'] as $product_option_value) {
								$this->db->query("INSERT INTO " . DB_PREFIX . "product_option_value SET product_option_value_id = '" . (int)$product_option_value['product_option_value_id'] . "', product_option_id = '" . (int)$product_option_id . "', product_id = '" . (int)$product_id . "', option_id = '" . (int)$product_option['option_id'] . "', option_value_id = '" . (int)$product_option_value['option_value_id'] . "', quantity = '100', subtract = '1', price = '" . (float)$product_option_value['price'] . "', price_prefix = '+', points = '0', points_prefix = '+', weight = '0', weight_prefix = '+'");
							}
						}
						} else {
		...
		public function addProduct($data) {
			...
			$this->db->query("INSERT INTO " . DB_PREFIX . "purpletree_vendor_products SET product_id = '" . (int)$product_id."', seller_id = '".(int)$data['seller_id']."', is_approved ='".(int)$is_approved."',is_featured ='".(int)$is_featured."',is_category_featured ='".(int)$is_category_featured."',delivery_address = '".$this->db->escape($data['delivery_address'])."', created_at =NOW(), updated_at =NOW()");
	   ...
	   ////  end quick order ////
			...
			$this->db->query("UPDATE " . DB_PREFIX . "purpletree_vendor_products SET is_approved ='".(int)$is_approved."',is_featured ='".(int)$is_featured."',is_category_featured ='".(int)$is_category_featured."',delivery_address ='".$this->db->escape($data['delivery_address'])."', updated_at =NOW() WHERE product_id = '" . (int)$product_id."' AND seller_id = '".(int)$seller_id."'");
