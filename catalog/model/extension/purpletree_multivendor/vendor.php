...
class ModelExtensionPurpletreeMultivendorVendor extends Model
{
	...
	{
		$this->db->query("INSERT into " . DB_PREFIX . "purpletree_vendor_stores SET seller_id ='" . (int)$customer_id . "', 
		store_name='" . $this->db->escape(trim($store_name)) . "', 
		multi_store_id='" . (int)($this->config->get('config_store_id')) . "',
		store_status='" . (int)(!$this->config->get('module_purpletree_multivendor_seller_approval')) . "', 
	...
	public function editStoreImage($store_id, $store_logo, $store_banner, $pan_doc, $msme_crt_doc)
	{
		$this->db->query("UPDATE " . DB_PREFIX . "purpletree_vendor_stores SET  store_logo='" . $this->db->escape($store_logo) . "',
			store_banner='" . $this->db->escape($store_banner) . "',
			pan_doc ='" . $this->db->escape($pan_doc) . "',	
			msme_crt_doc ='" . $this->db->escape($msme_crt_doc) . "',
	...
	public function editStore($store_id, $data, $file = '')
	{
		...
		$this->db->query("UPDATE " . DB_PREFIX . "purpletree_vendor_stores SET store_name='" . $this->db->escape(trim($data['store_name'])) . "', store_logo='" . $this->db->escape($data['store_logo']) . "',
			store_email='" . $this->db->escape($data['store_email']) . "', store_phone='" . $this->db->escape($data['store_phone']) . "', store_image='" . $this->db->escape($data['store_image']) . "', 
			store_banner='" . $this->db->escape($data['store_banner']) . "', store_description='" . $this->db->escape($data['store_description']) . "'" . $dcument . $store_live_chat_enable . $store_live_chat_code . " , 
			store_address='" . $this->db->escape($data['store_address']) . "',store_timings='" . $this->db->escape($data['store_timings']) . "',google_map='" . $this->db->escape($data['google_map']) . "',
			google_map_link='" . $this->db->escape($data['google_map_link']) . "',store_video='" . $this->db->escape($data['store_video']) . "', store_city='" . $this->db->escape($data['store_city']) . "',
			store_country='" . (int)$data['store_country'] . "', store_state='" . (int)$data['store_state'] . "',vacation='" . (int)$data['vacation'] . "',store_state='" . (int)$data['store_state'] . "', 
			store_zipcode='" . $this->db->escape($data['store_zipcode']) . "', store_shipping_policy='" . $this->db->escape($data['store_shipping_policy']) . "', 
			store_return_policy='" . $this->db->escape($data['store_return_policy']) . "', store_meta_keywords='" . $this->db->escape($data['store_meta_keywords']) . "', 
			store_meta_descriptions='" . $this->db->escape($data['store_meta_description']) . "', store_bank_details='" . $this->db->escape($data['store_bank_details']) . "', 
			store_tin='" . $this->db->escape($data['store_tin']) . "', store_shipping_type ='" . $this->db->escape($data['store_shipping_type']) . "',
			store_shipping_order_type ='" . $this->db->escape($data['store_shipping_order_type']) . "',store_shipping_charge =" . $store_shipping_charge . ",
			seller_paypal_id ='" . $this->db->escape($data['seller_paypal_id']) . "',
			...
			is_msme ='" . $this->db->escape($data['is_msme']) . "',
			uam ='" . $this->db->escape($data['uam']) . "',
			memorandum ='" . $this->db->escape($data['memorandum']) . "',
			msme_type ='" . $this->db->escape($data['msme_type']) . "',
			date_of_issue ='" . $this->db->escape($data['date_of_issue']) . "',
			validity_year ='" . $this->db->escape($data['validity_year']) . "',
			
			
			address_1 ='" . $this->db->escape($data['address_1']) . "',
			address_2 ='" . $this->db->escape($data['address_2']) . "',
			address_3 ='" . $this->db->escape($data['address_3']) . "',
			store_country_reg ='" . $this->db->escape($data['store_country_reg']) . "',
			store_state_reg ='" . $this->db->escape($data['store_state_reg']) . "',
			store_city_reg ='" . $this->db->escape($data['store_city_reg']) . "',
			pin_reg ='" . $this->db->escape($data['pin_reg']) . "',
			firstname_reg ='" . $this->db->escape($data['firstname_reg']) . "',
			lastname_reg ='" . $this->db->escape($data['lastname_reg']) . "',
			mobile_reg ='" . $this->db->escape($data['mobile_reg']) . "',
			mobile_alternate_reg ='" . $this->db->escape($data['mobile_alternate_reg']) . "',
			email_ger ='" . $this->db->escape($data['email_ger']) . "',
			email_alternate_reg ='" . $this->db->escape($data['email_alternate_reg']) . "',
			website_reg ='" . $this->db->escape($data['website_reg']) . "',
